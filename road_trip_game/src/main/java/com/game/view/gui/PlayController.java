...
import com.game.model.levels.LevelException;
...
public class PlayController {
    ...
    /**
     * Reloads the game and paints the level in the GUI again.
     * @throws LevelException when the game fails reloading.
     */
    @FXML
    private void reload() throws LevelException {
        game.reload();
        paint();
    }
